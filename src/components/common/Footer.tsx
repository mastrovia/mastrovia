            ...
            <div className="container mx-auto px-4 sm:px-6 lg:px-8">
                <div className="grid grid-cols-1 md:grid-cols-12 gap-12 lg:gap-8 items-start">
                    ...
                    <div className="md:col-span-3 lg:col-span-2 lg:col-start-7 flex flex-col gap-4">
                        ...
                        <Link href="/contact" className="text-base text-muted-foreground hover:text-primary transition-colors tracking-normal">Contact</Link>
                    </div>

                    {/* Resources & Support */}
                    <div className="md:col-span-4 lg:col-span-3 flex flex-col gap-4">
                        <h3 className="text-sm font-bold uppercase tracking-widest text-foreground/80 mb-2">Resources</h3>
                        <Link href="/cost-estimate" className="text-base text-muted-foreground hover:text-primary transition-colors tracking-normal">Cost Estimate</Link>
                        <Link href="/#faq" className="text-base text-muted-foreground hover:text-primary transition-colors tracking-normal">FAQs</Link>
                        <div className="flex gap-4 mt-4">
                            <a href="https://github.com/mastrovia" target="_blank" rel="noreferrer" className="w-10 h-10 rounded-full border border-border/50 flex items-center justify-center hover:bg-primary hover:text-primary-foreground transition-all duration-300">
                            ...
                            <a href="https://instagram.com/mastrovia.dev" target="_blank" rel="noreferrer" className="w-10 h-10 rounded-full border border-border/50 flex items-center justify-center hover:bg-primary hover:text-primary-foreground transition-all duration-300">
